-- link: https://github.com/MariaSolOs/dotfiles/blob/bda5388e484497b8c88d9137c627c0f24ec295d7/.config/nvim/lua/lsp.lua#L238-L259
...
local function on_attach(client, bufnr)
  ...
  keymap("gy", "<cmd>Telescope type_definitions<cr>", "Go to type definition")

  keymap("K", vim.lsp.buf.hover, "Hover")

  keymap("<leader>fs", "<cmd>Telescope lsp_document_symbols<cr>", "Document symbols")
