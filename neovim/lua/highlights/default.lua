...
function H.default_colorscheme()
  ...
  if vim.o.background == "light" then
    ...
    vim.api.nvim_set_hl(0, "@lsp.typemod.property.defaultLibrary.typescript", { fg = "NvimDarkGrey", bold = true })
    ...
    vim.api.nvim_set_hl(0, "Keyword", { fg = "NvimDarkBlue", bold = true, italic = false })
    ...
    vim.api.nvim_set_hl(0, "Keyword", { fg = "NvimLightBlue", bold = true, italic = false })
